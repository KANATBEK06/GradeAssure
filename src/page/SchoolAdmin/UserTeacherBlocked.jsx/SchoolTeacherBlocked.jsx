...
import classes from './SchoolTeacherBlocked.module.css'

const SchoolTeacherBlocked = ({ studentData }) => {
      ...
      <div className={classes.MainContainer}>
        <div className={classes.ButtonContainer}>
          <div className={classes.StudentButton}>
            <Button variant='teacher'>Students</Button>
          </div>
          <div className={classes.TeacherButton}>
            <Button variant='students'>Teachers</Button>
          </div>
        </div>
...
export default SchoolTeacherBlocked
